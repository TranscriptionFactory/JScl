# Model Peds LS vs Healthy - 50 top var genes
...
data <- subset(x = data, subset = (onset == "Peds" & health == "LS"))
...
saveRDS(Var.df2, '/ix/djishnu/Aaron/3_collabs/1_Torok_Jscl_ER/ER_analysis/data/new_clusters_50/PedsLoSAI_pre.RDS')

# write.csv(Var.df2, "/ix/djishnu/Aaron/3_collabs/1_Torok_Jscl_ER/ER_analysis/data/VarPedsLS_RM.csv")
...
saveRDS(df, '/ix/djishnu/Aaron/3_collabs/1_Torok_Jscl_ER/ER_analysis/data/Giffin_new_annotations/PedsLoSAI.RDS')
# #
# # write.csv(check_y2, "/ix/djishnu/Aaron/3_collabs/1_Torok_Jscl_ER/ER_analysis/data/check_yPeds.csv", row.names = F)
#
