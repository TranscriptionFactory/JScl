...
data = LoadH5Seurat('path/to/seurat/object')
#### ALL SAMPLES
...
for (i in 1:length(clusters)
  ...
  # this line removes mitochondrial and ribosomal genes
...
saveRDS(Var.df2, 'output/path.RDS')
# write.csv(Var.df2, "output/path.csv")
...
saveRDS(df, '/output/path.RDS')
write.csv(check_y2, "output/path.csv", row.names = F)
